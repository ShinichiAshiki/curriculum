    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            if (Objects.nonNull(resEmployeeBean)) {
                ...
                Logger.log(new Throwable(),resEmployeeBean.getPassword());
                Logger.log(new Throwable(),hashPassword);//ASK
                Logger.log(new Throwable(),resEmployeeBean.getPassword().equals("admin"));//ASK
